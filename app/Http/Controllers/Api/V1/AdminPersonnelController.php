...
class AdminPersonnelController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'nomor_hp' => 'required|string|digits_between:10,13|unique:personnels,nomor_hp',
            ...
            'nomor_hp.unique' => 'Nomor WhatsApp / HP sudah terdaftar di sistem.',
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'nomor_hp' => [
                ...
                Rule::unique('personnels', 'nomor_hp')->ignore($id),
            ],
            'email' => [
                'required',
                'email',
