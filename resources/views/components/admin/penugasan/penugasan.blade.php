<div>
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between mb-6">
        <div>
            <h1 class="text-xl font-black uppercase">Manajemen Penugasan</h1>
            ...
            <ul>
                ...
                <li>
                    <a href="{{ route('penugasan') }}">
                        <span class="text-base-content font-bold">Penugasan</span>
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div class="form-control">
            <div class="flex flex-col sm:flex-row items-center gap-3">
                ...
                <div class="relative w-full sm:w-auto">
                    <input type="text" placeholder="Nama penugasan..." wire:model.live.debounce.400ms="search"
    ...
    <div class="card bg-base-100 shadow-sm mb-6">
        <div class="card-body p-0">
                    ...
                    <tbody>
                        @forelse ($this->penugasans as $r)
                            <tr class="hover:bg-base-200/50">
                                <td class="text-center font-bold">{{ $this->penugasans->firstItem() + $loop->index }}
                                </td>
                                <td>
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="text-center text-sm text-base-content/60 py-8">Tidak ada data
                                    Penugasan</td>
                            </tr>
                        @endforelse
                    </tbody>
            ...
            <div class="card-actions justify-between items-center p-4 border-t border-base-200">
                <div class="w-full">{{ $this->penugasans->links('components.admin.pagination') }}</div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-box shadow max-h-[80vh] overflow-y-auto relative">
            <div class="flex justify-between items-center mb-4">
                ...
                <button type="button" class="btn btn-ghost btn-sm btn-circle"
                    onclick="document.getElementById('penugasan-modal').close()">✕</button>
            </div>
            <form wire:submit="save">
                <div class="space-y-4">
                    ...
                    <div class="form-control w-full">
                        ...
                        <input type="text" wire:model="name"
                            ...
                            placeholder="Cth: Tugas Pengawasan Lapangan">
                        @error('name')
                ...
                <div class="modal-action mt-6">
                    <button type="button" class="btn btn-ghost"
                        x-on:click="document.getElementById('penugasan-modal').close()">Batal</button>
        ...
        <div class="modal-box">
            ...
            <div class="modal-action">
                <button type="button" class="btn"
                    x-on:click="document.getElementById('penugasan-delete-modal').close()">Batal</button>
