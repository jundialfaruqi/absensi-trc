                                            ...
                                            <div
                                                ...
                                                @if ($platformMasuk === 'android')
                                                    <div
                                                        ...
                                                        <span
                                                            class="uppercase tracking-wide break-all">{{ $officialDeviceNameMasuk ?? ($deviceNameMasuk ?? 'Android') }}</span>
                                                    </div>
                                                @else
                                                    <div
                                                        class="flex items-center gap-1 text-base-content/75 font-semibold text-[10px]">
                                                        ...
                                                        <span class="uppercase tracking-wide">WEB</span>
                                                    </div>
                                                @endif
                                            ...
                                            <div
                                                ...
                                                @if ($platformPulang === 'android')
                                                    <div
                                                        ...
                                                        <span
                                                            class="uppercase tracking-wide break-all">{{ $officialDeviceNamePulang ?? ($deviceNamePulang ?? 'Android') }}</span>
                                                    </div>
                                                @else
                                                    <div
                                                        class="flex items-center gap-1 text-base-content/75 font-semibold text-[10px]">
