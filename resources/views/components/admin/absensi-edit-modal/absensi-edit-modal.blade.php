        ...
        <div class="modal-box p-0 shadow max-h-[80vh] max-w-2xl overflow-y-auto relative">
            ...
            <div class="p-6 border-b border-base-200 bg-base-200 flex justify-between items-center sticky top-0 z-50">
                <div class="flex items-center gap-3">
                    ...
                    <div x-show="loading" class="w-8 h-8 rounded-full bg-base-content/10 animate-pulse"></div>
                    {{-- Loaded Header Avatar --}}
                    ...
                    <h3 class="font-bold text-lg">
                        <span x-show="loading"
                            class="inline-block h-6 w-48 bg-base-content/10 rounded animate-pulse"></span>
                        <span x-show="!loading" class="align-middle">{{ $editingPersonnelName }}</span>
                    </h3>
                </div>
            ...
            <div class="overflow-y-auto flex-1">
                ...
                <div x-show="!loading">
                    <form wire:submit="saveEdit" class="p-6 space-y-5">
                                        ...
                                        <div class="mt-2 flex flex-col gap-1">
                                            <div
                                                ...
                                                @if ($platformMasuk === 'android')
                                                    <div
                                                        class="badge badge-neutral h-auto py-1.5 px-2 gap-1 whitespace-normal break-words text-left">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                            viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                                                        ...
                                                        <span
                                                            class="text-[9px] font-bold uppercase break-all">{{ $officialDeviceNameMasuk ?? ($deviceNameMasuk ?? 'Android') }}</span>
                                                    </div>
                                                @else
                                                    <div
                                                        class="badge badge-ghost h-auto py-1.5 px-2 gap-1 border-base-300 whitespace-normal break-words text-left">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                            viewBox="0 0 24 24" stroke-width="2"
                                                            stroke="currentColor" class="size-2.5 shrink-0">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                            ...
                                            <div
                                                ...
                                                @if ($platformPulang === 'android')
                                                    <div
                                                        ...
                                                        <span
                                                            class="text-[9px] font-bold uppercase break-all">{{ $officialDeviceNamePulang ?? ($deviceNamePulang ?? 'Android') }}</span>
                                                    </div>
                                                @else
                                                    <div
                                                        class="badge badge-ghost h-auto py-1.5 px-2 gap-1 border-base-300 whitespace-normal break-words text-left">
                        ...
                        <div
                            class="modal-action flex flex-row items-center justify-between gap-2 pt-4 border-t border-base-200">
