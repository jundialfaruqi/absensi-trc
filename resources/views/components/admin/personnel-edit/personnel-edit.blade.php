                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-x-6 md:gap-y-4">
                                ...
                                <div class="form-control w-full md:col-span-2">
                                    @if ($has_personal_device)
                                        <div
                                            class="flex items-center gap-4 bg-base-200/50 p-4 rounded-xl border border-base-300">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <span
                                                    class="label-text font-bold block uppercase text-xs whitespace-normal text-base-content/70">Perangkat
                                                    Terdaftar</span>
                                                <span
                            ...
                            init() {
                                ...
                                if (typeof EchoConstructor === 'function' && !window.Echo) {
                                    try {
                                        ...
                                        const wsPort = {{ config('broadcasting.connections.reverb.options.port', 8080) }};
                                        const forceTLS = {{ config('broadcasting.connections.reverb.options.useTLS') ? 'true' : 'false' }};
