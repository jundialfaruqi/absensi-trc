                                ...
                                <div class="flex flex-col gap-4 items-center">
                                    ...
                                    <div class="flex flex-col gap-4 items-center w-full">
                                        ...
                                        <div class="flex flex-col gap-3 w-full max-w-70">
                                            ...
                                            {{-- Biometric Status Badges (Dual-Stack 128D / 192D / 512D) --}}
                                            <div class="flex flex-wrap gap-1.5 pt-1">
                                                ...
                                                @if ($face_descriptor_mobile)
                                                    <span
                                                        class="badge badge-info badge-xs gap-1 py-1.5 px-2 text-[10px]"
                                                ...
                                                @else
                                                    <span
                                                        ...
                                                        title="512-D ArcFace belum terdaftar">
