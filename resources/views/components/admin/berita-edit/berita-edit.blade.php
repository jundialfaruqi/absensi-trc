<div>
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between mb-6">
        <div>
            <h1 class="text-xl font-black uppercase">Edit Berita</h1>
            <p class="text-sm text-base-content/60 mt-1">Perbarui berita atau informasi</p>
        </div>
        <div class="text-sm breadcrumbs text-base-content/60 hidden md:block">
            <ul>
                ...
                <li>
                    <span class="text-base-content font-bold">Edit Berita</span>
                </li>
            </ul>
        </div>
    </div>
                    ...
                    <div class="card-body space-y-4">
                        ...
                        <div class="form-control" x-data="{ isConverting: false, progress: 0 }">
                            ...
                            @if ($existingGambar && !$gambar)
                                <div class="relative rounded-xl overflow-hidden border-2 border-base-200 mb-2">
                                    <img src="{{ asset('storage/' . $existingGambar) }}"
                                        class="w-full h-auto object-cover" alt="Gambar berita">
                                    <button type="button" wire:click="removeGambar"
                                        class="absolute top-2 right-2 btn btn-error btn-xs btn-circle text-white">
