            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="border-b border-white/5 bg-white/2">
                        <th class="px-6 py-5 text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">Tanggal / Shift</th>
                        <th class="px-6 py-5 text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">Masuk</th>
                        <th class="px-6 py-5 text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">Pulang</th>
                        <th class="px-6 py-5 text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">Keterangan</th>
                    </tr>
                </thead>
                        ...
                        <tr class="group hover:bg-white/2 transition-colors">
                            ...
                            <td class="px-6 py-6">
                                <div class="flex items-center gap-4">
                                    @if($item->foto_masuk)
                                        <div class="h-10 w-10 rounded-lg border border-white/10 overflow-hidden shrink-0">
                                            <img src="{{ asset('storage/' . $item->foto_masuk) }}" class="h-full w-full object-cover">
                                        </div>
                                    @endif
                                    <div class="flex flex-col gap-1">
                                        @if($item->jam_masuk)
                                            ...
                                            <span class="text-[8px] font-bold uppercase tracking-widest {{ $item->status_masuk === 'tepat_waktu' ? 'text-emerald-500' : 'text-amber-500' }}">
                            ...
                            <td class="px-6 py-6">
                                <div class="flex items-center gap-4">
                                    @if($item->foto_pulang)
                                        <div class="h-10 w-10 rounded-lg border border-white/10 overflow-hidden shrink-0">
                                            <img src="{{ asset('storage/' . $item->foto_pulang) }}" class="h-full w-full object-cover">
                                        </div>
                                    @endif
                                    <div class="flex flex-col gap-1">
                                        @if($item->jam_pulang)
                                            ...
                                            <span class="text-[8px] font-bold uppercase tracking-widest {{ $item->status_pulang === 'tepat_waktu' ? 'text-emerald-500' : 'text-amber-500' }}">
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-20 text-center">
                                <div class="flex flex-col items-center gap-3">
                                    ...
                                    <p class="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">Belum ada riwayat absensi</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
