<div class="max-w-3xl mx-auto space-y-8 animate-in slide-in-from-bottom-4 duration-700">
    ...
    <div class="flex items-center justify-between gap-4">
        <div class="space-y-1">
            <a href="{{ url('/personnel/dashboard') }}" class="group inline-flex items-center gap-2 text-slate-500 hover:text-blue-400 text-[10px] font-black uppercase tracking-widest transition-colors mb-2">
    ...
    @if (session()->has('success'))
        <div class="p-4 bg-emerald-500/10 border border-emerald-500/20 rounded-2xl flex items-center gap-3 animate-bounce-short">
            ...
            <span class="text-[10px] font-black text-emerald-500 uppercase tracking-wider">{{ session('success') }}</span>
        </div>
    @endif
    ...
    <div class="glass-panel p-8 md:p-10 rounded-[2.5rem] border-white/5 relative overflow-hidden">
        ...
        <form wire:submit.prevent="updateProfile" class="space-y-8 relative z-10">
            ...
            <div class="space-y-4">
                ...
                <div class="space-y-2">
                    <label class="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] ml-1">Alamat Email Aktif</label>
                    ...
                    @error('email') <span class="text-[9px] font-bold text-red-500 uppercase tracking-widest ml-1 italic">{{ $message }}</span> @enderror
                </div>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label class="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] ml-1">Password Baru</label>
                        ...
                        @error('password') <span class="text-[9px] font-bold text-red-500 uppercase tracking-widest ml-1 italic">{{ $message }}</span> @enderror
                    </div>
                    <div class="space-y-2">
                        <label class="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] ml-1">Konfirmasi Password</label>
                ...
                <div class="space-y-2">
                    <label class="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] ml-1">Update Kode PIN (4 Digit)</label>
                    ...
                    @error('pin') <span class="text-[9px] font-bold text-red-500 uppercase tracking-widest ml-1 italic">{{ $message }}</span> @enderror
                    <p class="text-[8px] font-bold text-slate-500 uppercase tracking-widest italic ml-1">PIN digunakan untuk verifikasi cepat pada perangkat mobile (4 Digit).</p>
                </div>
            </div>
            ...
            <div class="pt-4">
                <button type="submit" wire:loading.attr="disabled"
                    class="w-full h-15 bg-blue-600 hover:bg-blue-500 text-white font-black uppercase tracking-[0.2em] rounded-2xl shadow-xl shadow-blue-600/20 transition-all transform hover:scale-[1.01] active:scale-[0.28] grid place-items-center group relative overflow-hidden">
